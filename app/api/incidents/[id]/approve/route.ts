...
// Approve new incident (user-created, was Pending)
export async function POST(
  ...
  try {
    ...
    rq.input('ApprovedByUserId', approvedByUserId || null);
    ...
    return withCORS(NextResponse.json({ ok: true, message: 'Incident approved' }));
  } catch (e: any) {
